      ...
      <div class="relative w-full h-full">
        ...
        >
          <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute inset-0 bg-gradient-to-br from-blue-200 via-pink-100 to-purple-200 opacity-80 animate-gradient-move"></div>
            ...
            >
              ...
              ></path>
              <defs>
                <linearGradient id="formWaveGradient" x1="0" x2="1" y1="0" y2="1">
